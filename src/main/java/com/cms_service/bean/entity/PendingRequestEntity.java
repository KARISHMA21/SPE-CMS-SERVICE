...
public class PendingRequestEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(pendingRequestId, that.pendingRequestId) && Objects.equals(pid, that.pid) && Objects.equals(requestor_id, that.requestor_id) && Objects.equals(superid, that.superid) && Objects.equals(requestor_eid, that.requestor_eid) && Objects.equals(requestor_ename, that.requestor_ename) && Objects.equals(requestor_name, that.requestor_name) && Objects.equals(tag1, that.tag1) && Objects.equals(tag2, that.tag2) && Objects.equals(tag3, that.tag3) && Objects.equals(reason, that.reason) && Objects.equals(request_date, that.request_date) && Objects.equals(from_date, that.from_date) && Objects.equals(to_date, that.to_date) && Objects.equals(expiry_date, that.expiry_date);
    }

    @Override
    public int hashCode() {
        return Objects.hash(pendingRequestId, pid, requestor_id, superid, requestor_eid, requestor_ename, requestor_name, tag1, tag2, tag3, reason, request_date, from_date, to_date, expiry_date);
    }
